...
sensors_names = {2: 'Grupa9UltrazvucniSenzor2', 3: 'Grupa9UltrazvucniSenzor3', 4: 'Grupa9UltrazvucniSenzor4', 5: 'Grupa9UltrazvucniSenzor5', 6: 'Grupa9UltrazvucniSenzor6'}
...
while True:
    ...
    if sensor_status == 0:
        ...
        if action == 0:
            ...
            virtual_sensors_helper.create_sensor_reading(sensors_names[sensor_id], 2)   # free parking space in now reserved
            sensors_statuses[sensor_id] = 2
